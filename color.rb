...
module Color
  ...
  TRANSPARENT = { r: 0, g: 0, b: 0, a: 0 }.freeze
    ...
    # returns all of the colors this module provides, as an array.
  ALL = [
    ALICEBLUE, ANTIQUEWHITE, AQUA, AQUAMARINE, AZURE,
    BEIGE, BISQUE, BLACK, BLANCHEDALMOND, BLUE, BLUEVIOLET, BROWN, BURLYWOOD,
    CADETBLUE, CHARTREUSE, CHOCOLATE, CORAL, CORNFLOWER, CORNFLOWERBLUE, CORNSILK, CRIMSON, CYAN,
    ...
    KHAKI,
    LASERLEMOON, LAVENDER, LAVENDERBLUSH, LAWNGREEN, LEMONCHIFFON, LIGHTBLUE, LIGHTCORAL, LIGHTCYAN,
    ...
    SADDLEBROWN, SALMON, SANDYBROWN, SEASHELL, SIENNA, SILVER, SKYBLUE, SLATEBLUE, SLATEGRAY, SLATEGREY, SNOW,
    ...
    # Nokia Jam
    NOKIALIGHT, NOKIADARK, NOKIAHARSHLIGHT, NOKIAHARSHDARK, NOKIAGRAYLIGHT,
    NOKIAGREYLIGHT, NOKIAGRAYDARK, NOKIAGREYDARK,

    # Dragonruby
    DRAGONRED, DRAGONGRAY, DRAGONGREY
  ]
